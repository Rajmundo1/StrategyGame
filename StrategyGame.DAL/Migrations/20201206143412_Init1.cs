        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WoodPictureUrl = table.Column<string>(nullable: true),
                    MarblePictureUrl = table.Column<string>(nullable: true),
                    WinePictureUrl = table.Column<string>(nullable: true),
                    SulfurPictureUrl = table.Column<string>(nullable: true),
                    GoldPictureUrl = table.Column<string>(nullable: true),
                    TechnologyPictureUrl = table.Column<string>(nullable: true),
                    ForceLimitPictureUrl = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ResearchPoint = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BasePopulation = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("e2bfc4a7-d73f-4a2e-b91f-209c08a3f14f"), "A sawmill that produces wood", "/images/sawmill.png", 3, "Sawmill" },
                    { new Guid("1d203260-0928-47b6-9d10-5e4cf0c70265"), "A marble quarry that produces marble", "/images/quarry.png", 3, "Quarry" },
                    { new Guid("4db1c8d2-b2b0-49a9-b8a5-8f9d5bbecddb"), "A winery that produces wine", "/images/winery.png", 3, "Winery" },
                    { new Guid("d02e3c9c-f26c-4136-a904-27ad074fa456"), "A sulfur mine that produces sulfur", "/images/sulfurMine.png", 3, "Sulfur Mine" },
                    { new Guid("598fd678-5915-4c88-80d8-ff389c8278f9"), "An academy that produces research points", "/images/academy.png", 3, "Academy" },
                    { new Guid("3a8ffb5d-6edb-4908-a72e-3d268128efee"), "A garrison that accomodate units", "/images/garrison.png", 3, "Garrison" }
                });

            migrationBuilder.InsertData(
                table: "Game",
                columns: new[] { "Id", "ForceLimitPictureUrl", "GoldPictureUrl", "MarblePictureUrl", "Round", "SulfurPictureUrl", "TechnologyPictureUrl", "WinePictureUrl", "WoodPictureUrl" },
                values: new object[] { new Guid("1bb1f3c1-8c10-439c-8dcb-7f8cc1f8044e"), "/images/forcelimit.png", "/images/gold.png", "/images/marble.png", 0, "/images/sulfur.png", "/images/technology.png", "/images/wine.png", "/images/wood.png" });

            migrationBuilder.InsertData(
                table: "Kingdoms",
                columns: new[] { "Id", "Gold", "ResearchPoint" },
                values: new object[,]
                {
                    { new Guid("5fd3e0a3-0e0e-445a-93e6-8f94b6690794"), 3000, 2000 },
                    { new Guid("a37de913-486d-4df3-9025-1e5d4f881220"), 3000, 2000 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("a6336474-fa17-43ba-a5c6-7fee92ab15b7"), 0.0, 0.0, "Boosts all production", 0.0, "Production Booster", "/images/productionBooster.png", 0.0, 1000, 1.1000000000000001, 1.1000000000000001, 1.1000000000000001, 1.1000000000000001 },
                    { new Guid("f7f7f6a9-1ce5-4051-82b0-a55fb19d901c"), 0.0, 0.0, "Boosts research output", 0.0, "Science Booster", "/images/scienceBooster.png", 1.2, 1000, 0.0, 0.0, 0.0, 0.0 },
                    { new Guid("93ad7e45-7071-48d5-a5df-c5eb21bb35da"), 0.0, 0.0, "Boosts gold production", 1.3, "Gold Production Booster", "/images/goldProductionBooster.png", 0.0, 1000, 0.0, 0.0, 0.0, 0.0 },
                    { new Guid("4e9f32b6-2621-4f7c-a939-f4d1a1a2daae"), 1.1499999999999999, 1.1000000000000001, "Unit booster research", 0.0, "Unit Booster", "/images/unitBooster.png", 0.0, 1000, 0.0, 0.0, 0.0, 0.0 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("97f6314a-766d-4aa2-9c49-7dbcf86140b5"), "A melee unit that is strong in close combat", "/images/hoplite.png", 3, "Hoplite" },
                    { new Guid("489e9070-f6f6-4130-8979-89e54b140835"), "A ranged unit that is strong in ranged combat", "/images/archer.png", 3, "Archer" },
                    { new Guid("06d69f35-d7f8-444f-bd25-da45bc6accb6"), "A ranged unit that is the strongest in ranged combat", "/images/catapult.png", 3, "Catapult" }
                });

            migrationBuilder.InsertData(
                table: "AspNetUsers",
                columns: new[] { "Id", "AccessFailedCount", "ConcurrencyStamp", "Email", "EmailConfirmed", "GameId", "KingdomId", "LockoutEnabled", "LockoutEnd", "NormalizedEmail", "NormalizedUserName", "PasswordHash", "PhoneNumber", "PhoneNumberConfirmed", "RefreshToken", "ScoreboardPlace", "SecurityStamp", "TwoFactorEnabled", "UserName" },
                values: new object[,]
                {
                    { "ff5e4b7f-c83d-4070-a91a-a33de1b19405", 0, "14c670cf-1d3a-488b-8916-8e0de92ef2b4", null, false, new Guid("1bb1f3c1-8c10-439c-8dcb-7f8cc1f8044e"), new Guid("5fd3e0a3-0e0e-445a-93e6-8f94b6690794"), false, null, null, "RAJMUNDO1", "AQAAAAEAACcQAAAAEBO4RZ7cGpA2CADIF268TxgD8HQIv/M7uUbY6ZJo03r4K5U1/7D7kk2cipWPJEPShg==", null, false, null, 1, "e1c76fb4-445b-4b30-a75d-a37a5e7bcc17", false, "Rajmundo1" },
                    { "b63d4aee-70d2-4d84-93a6-56c9db32aa11", 0, "f9389b39-253a-4a70-829a-e8e9dee9af6f", null, false, new Guid("1bb1f3c1-8c10-439c-8dcb-7f8cc1f8044e"), new Guid("a37de913-486d-4df3-9025-1e5d4f881220"), false, null, null, "TESTUSER", "AQAAAAEAACcQAAAAEAz/O3QZGw6lkJfYvJUIU3iCHVg5ei19Q8eP8RwVOJK1BK52Wzq15kNH2bMpdRny8g==", null, false, null, 2, "117e6964-3fa1-4f03-8abd-d585d5bb2fc6", false, "TestUser" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("00f807d6-9017-4f80-80ab-8544d9343f72"), new Guid("3a8ffb5d-6edb-4908-a72e-3d268128efee"), 1000, 0, 3, 1500, 0, 0, 0, 2000, 0, 2500, 0, 10000, 0 },
                    { new Guid("205d6189-4fef-4777-afb8-9f73a835724e"), new Guid("3a8ffb5d-6edb-4908-a72e-3d268128efee"), 500, 0, 2, 200, 0, 0, 0, 0, 0, 800, 0, 1500, 0 },
                    { new Guid("547ad002-b237-474e-b68c-0018ddf4b77a"), new Guid("3a8ffb5d-6edb-4908-a72e-3d268128efee"), 100, 0, 1, 0, 0, 0, 0, 0, 0, 100, 0, 250, 0 },
            ...
            migrationBuilder.InsertData(
                table: "Counties",
                columns: new[] { "Id", "BasePopulation", "KingdomId", "Marble", "Name", "Sulfur", "TaxRate", "Wine", "WineConsumption", "Wood" },
                values: new object[,]
                {
                    { new Guid("01ef4de3-61c4-4671-bcd3-4b5009dea2d2"), 200, new Guid("a37de913-486d-4df3-9025-1e5d4f881220"), 5000, "Kingdom2 County2", 1000, 1.0, 2000, 0, 5000 },
                    { new Guid("9160fe49-2966-4fb6-94d7-6999c7351368"), 200, new Guid("5fd3e0a3-0e0e-445a-93e6-8f94b6690794"), 5000, "Kingdom1 County2", 1000, 1.0, 2000, 0, 5000 },
                    { new Guid("217f6d72-a33e-4612-b164-f1bbd5db94c2"), 200, new Guid("5fd3e0a3-0e0e-445a-93e6-8f94b6690794"), 5000, "Kingdom1 County1", 1000, 1.0, 2000, 0, 5000 },
                    { new Guid("610fb8b0-386e-4b0d-9a51-59403fd686b6"), 200, new Guid("a37de913-486d-4df3-9025-1e5d4f881220"), 5000, "Kingdom2 County1", 1000, 1.0, 2000, 0, 5000 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("e12a9bfd-1847-4e43-ae91-bcce2c5545a3"), new Guid("a37de913-486d-4df3-9025-1e5d4f881220"), 2, new Guid("4e9f32b6-2621-4f7c-a939-f4d1a1a2daae") },
                    { new Guid("605b6d6a-40dd-415d-8726-46ef8c0592bf"), new Guid("a37de913-486d-4df3-9025-1e5d4f881220"), 2, new Guid("93ad7e45-7071-48d5-a5df-c5eb21bb35da") },
                    ...
                    { new Guid("0d5fa209-cd89-4f26-bf6c-2f915a661226"), new Guid("a37de913-486d-4df3-9025-1e5d4f881220"), 2, new Guid("a6336474-fa17-43ba-a5c6-7fee92ab15b7") },
                    ...
                    { new Guid("67648201-cb7a-4904-8622-b2863444eb82"), new Guid("a37de913-486d-4df3-9025-1e5d4f881220"), 2, new Guid("f7f7f6a9-1ce5-4051-82b0-a55fb19d901c") }
                });

            migrationBuilder.InsertData(
                table: "UnitLevels",
                columns: new[] { "Id", "AttackPower", "DefensePower", "ForceLimit", "GoldCost", "GoldUpkeep", "Level", "MarbleCost", "MarbleUpkeep", "SulfurCost", "SulfurUpkeep", "UnitSpecificsId", "WineCost", "WineUpkeep", "WoodCost", "WoodUpkeep" },
                values: new object[,]
                {
                    { new Guid("cc847345-0747-45ee-ab9b-60a97873d9b1"), 20, 20, 10, 200, 50, 2, 100, 40, 100, 0, new Guid("06d69f35-d7f8-444f-bd25-da45bc6accb6"), 0, 0, 200, 100 },
                    { new Guid("3e1869eb-f12a-40e7-bec3-0b3ae410370a"), 3, 5, 1, 10, 5, 1, 0, 0, 0, 0, new Guid("97f6314a-766d-4aa2-9c49-7dbcf86140b5"), 0, 0, 15, 0 },
                    { new Guid("26f967a9-44b9-4aa9-88ae-b3af7ac0ad09"), 5, 8, 2, 15, 10, 2, 5, 0, 0, 0, new Guid("97f6314a-766d-4aa2-9c49-7dbcf86140b5"), 0, 0, 25, 0 },
                    { new Guid("15ec08c3-a2e0-42a9-bd5a-37381e121dcb"), 8, 12, 3, 30, 15, 3, 50, 0, 0, 0, new Guid("97f6314a-766d-4aa2-9c49-7dbcf86140b5"), 0, 0, 50, 0 },
                    { new Guid("2e560b5e-f626-4b25-8957-0337f385c2be"), 7, 2, 2, 10, 5, 1, 10, 5, 0, 0, new Guid("489e9070-f6f6-4130-8979-89e54b140835"), 0, 0, 15, 0 },
                    { new Guid("2c944d6f-a2ea-448a-a4f8-7756ef115263"), 10, 4, 3, 20, 10, 2, 15, 10, 0, 0, new Guid("489e9070-f6f6-4130-8979-89e54b140835"), 0, 0, 30, 0 },
                    { new Guid("b0563dec-ae9a-49df-bbc2-4db74bf5e2ec"), 15, 6, 4, 35, 20, 3, 20, 15, 0, 0, new Guid("489e9070-f6f6-4130-8979-89e54b140835"), 0, 0, 50, 0 },
                    { new Guid("e8cfbc91-d0c7-4ee4-a123-ce3e554026f8"), 10, 10, 5, 100, 20, 1, 50, 20, 50, 0, new Guid("06d69f35-d7f8-444f-bd25-da45bc6accb6"), 0, 0, 100, 50 },
                    { new Guid("9946dd5f-078a-4029-9ba1-0a3b22d8dfdc"), 30, 30, 15, 400, 100, 3, 200, 80, 200, 0, new Guid("06d69f35-d7f8-444f-bd25-da45bc6accb6"), 0, 0, 400, 200 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { new Guid("b1a4a941-00d1-4655-b96f-3fcd6ccff69c"), new Guid("3a8ffb5d-6edb-4908-a72e-3d268128efee"), new Guid("610fb8b0-386e-4b0d-9a51-59403fd686b6"), 1, 1 },
                    ...
                    { new Guid("0a4b02fa-ea0a-469a-8695-7c3ff01534dd"), new Guid("3a8ffb5d-6edb-4908-a72e-3d268128efee"), new Guid("01ef4de3-61c4-4671-bcd3-4b5009dea2d2"), 1, 1 },
                    { new Guid("76698e37-4e57-4405-895d-39812a0000b9"), new Guid("3a8ffb5d-6edb-4908-a72e-3d268128efee"), new Guid("9160fe49-2966-4fb6-94d7-6999c7351368"), 1, 1 },
                    ...
                    { new Guid("042767db-2f76-4fdd-99b7-fa0b3054ba3a"), new Guid("3a8ffb5d-6edb-4908-a72e-3d268128efee"), new Guid("217f6d72-a33e-4612-b164-f1bbd5db94c2"), 3, 1 },
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("739dbea4-c91c-4ba2-9ea5-62115d317e46"), null, new Guid("9160fe49-2966-4fb6-94d7-6999c7351368") },
                    ...
                    { new Guid("b32e83be-34f0-4bed-b225-966887eb13e4"), null, new Guid("01ef4de3-61c4-4671-bcd3-4b5009dea2d2") }
                });
